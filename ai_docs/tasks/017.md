...
1. **Hybrid Search Core Tests** (`tests/test_hybrid_search.py`):
```python
import pytest
...
2. **Search Quality Tests** (`tests/test_search_quality.py`):
```python
...
3. **Performance Tests** (`tests/test_hybrid_performance.py`):
```python
