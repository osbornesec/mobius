...
1. **Agent Registration Tests** (`tests/test_agent_coordination.py`):
```python
import pytest
...
2. **Message Routing Tests** (`tests/test_message_routing.py`):
```python
...
3. **Agent Coordination Tests** (`tests/test_agent_orchestration.py`):
```python
