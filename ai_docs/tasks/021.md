...
1. **API Client Configuration Tests** (`tests/test_api_clients.py`):
```python
import pytest
...
2. **Streaming Response Tests** (`tests/test_streaming.py`):
```python
...
3. **Error Handling Tests** (`tests/test_api_error_handling.py`):
```python
