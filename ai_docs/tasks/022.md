...
1. **Prompt Template Tests** (`tests/test_prompt_templates.py`):
```python
import pytest
...
2. **Few-Shot Learning Tests** (`tests/test_few_shot.py`):
```python
...
3. **Chain-of-Thought Tests** (`tests/test_chain_of_thought.py`):
```python
