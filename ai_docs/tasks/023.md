...
1. **Response Formatting Tests** (`tests/test_response_formatting.py`):
```python
import pytest
...
2. **Streaming Response Tests** (`tests/test_streaming_formatting.py`):
```python
...
3. **Content Validation Tests** (`tests/test_content_validation.py`):
```python
