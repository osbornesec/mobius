...
1. **Context Analysis Tests** (`tests/test_context_builder.py`):
```python
...
2. **Context Optimization Tests** (`tests/test_context_optimization.py`):
```python
...
3. **Agent Integration Tests** (`tests/test_context_agent_integration.py`):
```python
