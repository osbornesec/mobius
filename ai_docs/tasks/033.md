...
1. **Retrieval Accuracy Tests** (`tests/test_retrieval_agent.py`):
```python
...
2. **ML Ranking Tests** (`tests/test_ml_ranking.py`):
```python
...
3. **Performance Tests** (`tests/test_retrieval_performance.py`):
```python
