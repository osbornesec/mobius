...
1. **Multi-Tier Memory Tests** (`tests/test_multi_tier_memory.py`):
```python
...
2. **Intelligent Pruning Tests** (`tests/test_intelligent_pruning.py`):
```python
...
3. **User Interaction Learning Tests** (`tests/test_interaction_learning.py`):
```python
