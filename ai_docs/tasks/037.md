...
1. **Persona Definition Tests** (`tests/test_persona_definition.py`):
```python
...
2. **Dynamic Adaptation Tests** (`tests/test_dynamic_adaptation.py`):
```python
...
3. **Persona Switching Tests** (`tests/test_persona_switching.py`):
```python
