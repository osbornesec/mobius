...
1. **CI/CD Pipeline Tests** (`tests/backend/unit/test_cicd_pipeline.py`):
```python
...
2. **Infrastructure Management Tests** (`tests/backend/unit/test_infrastructure.py`):
```python
...
3. **Environment Management Tests** (`tests/backend/unit/test_environment_management.py`):
```python
