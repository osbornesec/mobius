...
1. **AI Help System Tests** (`tests/backend/unit/test_ai_help_system.py`):
```python
...
2. **Documentation Generation Tests** (`tests/backend/unit/test_doc_generation.py`):
```python
...
3. **Knowledge Base Tests** (`tests/backend/unit/test_knowledge_base.py`):
```python
