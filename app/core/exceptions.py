...
class InsufficientPermissionsError(AuthorizationError):
    ...
    def __init__(self, required_permission: str, resource: Optional[str] = None) -> None:
...
class RateLimitExceededError(RateLimitError):
    ...
    def __init__(self, limit: int, window: str, retry_after: Optional[int] = None) -> None:
        super().__init__(
...
class ResourceLockedError(BusinessLogicError):
    ...
    def __init__(self, resource: str, resource_id: str, locked_by: Optional[str] = None) -> None:
        details = {"resource": resource, "resource_id": resource_id}
        if locked_by:
...
class VectorDatabaseError(ExternalServiceError):
    ...
    def __init__(self, operation: str, message: str, details: Optional[Dict[str, Any]] = None) -> None:
        details = details or {}
