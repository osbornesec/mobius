...
class CorrelationIdMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        Generated by CodeRabbit
        """
        # Check if correlation ID exists in headers before generating
        correlation_id_exists = self._get_correlation_id_from_headers(request) is not None
