...
def get_request_id(request: Request) -> Optional[str]:
    ...
    Attempts to retrieve the request ID from the request's state (if set by middleware) or from the `X-Request-ID` header. Returns the request ID as a string if found, otherwise returns None.
    
    Checks for correlation ID in request state (set by CorrelationIdMiddleware)
    ...
    Returns:
        Optional[str]: The request ID as a string if available, otherwise None.
