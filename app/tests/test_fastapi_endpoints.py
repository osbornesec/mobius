...
class TestRootEndpoint:
    ...
    def test_root_endpoint_returns_expected_content(self):
        ...
        assert data["description"] == "Context Engineering Platform for AI Coding Assistants"
        assert "docs" in data
...
class TestPrometheusMetrics:
    ...
    def test_metrics_endpoint_accessible(self):
        ...
        assert "http_request_duration_highr_seconds" in response.text or "http_request" in response.text
