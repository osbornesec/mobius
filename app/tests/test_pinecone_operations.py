...
def generate_test_vectors(count: int, dimension: int) -> List[Tuple[str, List[float], Dict[str, Any]]]:
...
class TestPineconeOperations:
    ...
    def test_fetch_operations(self, test_index):
        ...
        fetch_response = test_index.fetch(
            ids=ids_to_fetch,
            namespace=TEST_NAMESPACE
        )
    ...
    def test_update_operations(self, test_index):
        ...
        original_vector = ("update-test", generate_random_vector(TEST_DIMENSION), {"version": 1})
    ...
    def test_delete_operations(self, test_index):
        ...
        delete_response = test_index.delete(
            ids=ids_to_delete,
            namespace=TEST_NAMESPACE
        )
    ...
    def test_list_operations(self, test_index):
        ...
        vector_ids = []
        for ids in test_index.list(prefix="list-test", namespace=TEST_NAMESPACE, limit=3):
...
class TestPineconeAsyncOperations:
    ...
    async def test_async_index_operations(self):
        ...
        try:
            ...
            pytest.skip("Async support not installed (install with pip install pinecone[asyncio])")
