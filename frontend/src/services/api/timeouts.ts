...
const DEFAULT_TIMEOUT = Number.parseInt(import.meta.env.VITE_API_TIMEOUT_DEFAULT || '10000');
const LONG_TIMEOUT = Number.parseInt(import.meta.env.VITE_API_TIMEOUT_LONG || '30000');
const SHORT_TIMEOUT = Number.parseInt(import.meta.env.VITE_API_TIMEOUT_SHORT || '5000');
const MAX_RETRIES = Number.parseInt(import.meta.env.VITE_API_MAX_RETRIES || '3');
const RETRY_DELAY = Number.parseInt(import.meta.env.VITE_API_RETRY_DELAY || '1000');
...
export function getTimeoutForEndpoint(url: string, method = 'GET'): number {
