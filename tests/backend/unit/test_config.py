...
def basic_env(monkeypatch):
    ...
    """
    monkeypatch.setenv(
        "MOBIUS_DATABASE__URL", "postgresql://user:pass@localhost/mobius"
    )
...
class TestConfigurationLoading:
    ...
    def test_load_full_config(self, clean_env, full_env):
        ...
        # Security settings
        assert (
            settings.security.secret_key.get_secret_value() == "super-secret-test-key"
        )
...
class TestConfigurationValidation:
    ...
    def test_json_list_parsing(self, clean_env, basic_env, monkeypatch):
        ...
        """
        monkeypatch.setenv(
            "MOBIUS_SECURITY__ALLOWED_ORIGINS",
...
class TestSensitiveDataHandling:
    ...
    def test_dict_export_with_secrets(self, clean_env, basic_env):
        ...
        assert isinstance(
            settings_dict_with_secrets["security"]["secret_key"], SecretStr
        )
...
""")
        ...
        assert (
            settings.database.url == "postgresql://file:pass@localhost/db"
        )  # From .env file
